...
//
    ...
    extension Reactive where Base: UIScrollView {
        ...
        public var contentOffset: ControlProperty<CGPoint> {
            ...
            let bindingObserver = Binder(self.base) { stackView, contentOffset in
                stackView.contentOffset = contentOffset
            }
        ...
        public var isScrollEnabled: Binder<Bool> {
            return Binder(self.base) { stackView, scrollEnabled in
                stackView.isScrollEnabled = scrollEnabled
            }
        }
